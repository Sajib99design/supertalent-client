      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 max-sm:text-center">
        <div>
          ...
          <ul className="space-y-3 mt-4">
            ...
            <li><Link to="/add-model" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Become Seller </Link></li>
            <li><Link to="/profile" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Jobs on Freeio</Link></li>
            <li><Link to="/auth/login" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Services Freeio </Link></li>
            <li><Link to="/auth/login" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Terms of Service</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link to="/" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Design & Creative</Link></li>
            <li><Link to="/" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Development & IT</Link></li>
            <li><Link to="/" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Programming & Tech</Link></li>
            <li><Link to="/resources" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Digital Marketing</Link></li>
            <li><Link to="/resources" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Finance & Accounting</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link to="/" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Help & Support </Link></li>
            <li><Link to="/" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">FAQ Freeio</Link></li>
            <li><Link to="/" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Services </Link></li>
            <li><Link to="/" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Terms of Service</Link></li>
            <li><Link to="/" className="text-gray-300 dark:text-gray-400 hover:text-blue-600">Contact Us</Link></li>
          </ul>
        </div>
          ...
          <div className='space-y-6'>
            ...
            <div>
              <a
                ...
                className="flex items-center max-sm:justify-center text-gray-400 dark:text-gray-500 hover:text-orange-900"
              >
